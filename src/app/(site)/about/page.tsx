...
import { ProfileIllustration } from "@/app/components/illustrations";
...
export default function AboutPage() {
  return (
    <main className="flex flex-col max-w-4xl p-4 my-auto lg:mx-auto md:gap-8">
      ...
      <div className="flex flex-col md:flex-row md:gap-8">
        <div  className="flex flex-shrink-0 mx-auto my-4 md:my-10">
